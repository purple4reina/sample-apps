...
CLOUDFRONT_MODIFY_RESPONSE_HEADER = {
  "Records": [
    {
      "cf": {
        "config": {
...
KINESIS_DATA_ANALYTICS = {
  ...
  "streamArn": "arn:aws:kinesis:us-west-2:123456789012:stream/example-stream",
  "records": [
    {
...
CLOUDFRONT_REDIRECT_UNAUTHENTICATED_USERS = {
  "Records": [
    {
      "cf": {
        "config": {
...
KINESIS_DATA_ANALYTICS_DYNAMODB = {
  "invocationId": "invocationIdExample",
  "applicationArn": "arn:aws:kinesisanalytics:us-west-2:123456789012:application/example-application",
  "streamArn": "arn:aws:kinesis:us-west-2:123456789012:stream/example-stream",
  "records": [
    {
      "recordId": "49571347871967966406409637155186850213682522142927749122",
      "data": "eyJST1dUSU1FX1RJTUVTVEFNUCI6IjIwMTctMTItMTUgMDE6MDk6NTAuMDAwIiwiVkVISUNMRUlEIjoiNSIsIlZFSElDTEVDT1VOVCI6MTh9"
    }
  ]
}
...
CONFIG_PERIODIC_RULE = {
  "invokingEvent": "{\"awsAccountId\":\"123456789012\",\"notificationCreationTime\":\"1970-01-01T00:00:00.0Z\",\"messageType\":\"ScheduledNotification\",\"recordVersion\":\"1.0\"}",
  "ruleParameters": "{\"myParameterKey\":\"myParameterValue\"}",
  "resultToken": "myResultToken",
  "eventLeftScope": False,
  "executionRoleArn": "arn:aws:iam::123456789012:role/config-role",
  "configRuleArn": "arn:aws:config:us-west-2:123456789012:config-rule/config-rule-0123456",
...
KINESIS_DATA_FIREHOSE_STREAMS_AS_SOURCE = {
  "invocationId": "invocationIdExample",
...
KINESIS_DATA_ANALYTICS_KPL = {
  ...
  "records": [
    ...
    {
      "recordId": "49571347871967966406409637141563465152445265354688561154",
      "kinesisStreamRecordMetadata": {
        "shardId": "shardId-000000000002",
        "partitionKey": "partitionKey-02",
        "approximateArrivalTimestamp": 1505169647777,
        "sequenceNumber": "49571347871967966406409637141563465152445265354688561154"
      },
      "data": "NCxhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWEK"
    }
  ]
}
...
API_GATEWAY_AUTHORIZER = {
  ...
  "methodArn": "arn:aws:execute-api:us-west-2:123456789012:example/prod/POST/{proxy+}"
}

CONFIG_CONFIGURATION_ITEM_CHANGE_NOTIFICATION = {
  "invokingEvent": "{\"configurationItem\":{\"configurationItemCaptureTime\":\"2016-10-06T16:46:16.261Z\",\"awsAccountId\":\"123456789012\",\"configurationItemStatus\":\"OK\",\"resourceId\":\"i-00000000\",\"resourceName\":\"foo\",\"configurationStateMd5Hash\":\"8f1ee69b297895a0f8bc5753eca68e96\",\"resourceCreationTime\":\"2016-10-06T16:46:10.489Z\",\"configurationStateId\":0,\"configurationItemVersion\":\"1.2\",\"ARN\":\"arn:aws:ec2:us-west-2:123456789012:instance/i-00000000\",\"awsRegion\":\"us-west-2\",\"availabilityZone\":\"us-west-2\",\"resourceType\":\"AWS::EC2::Instance\",\"tags\":{\"<Foo>\":\"<Bar>\"},\"relationships\":[{\"resourceId\":\"eipalloc-00000000\",\"resourceType\":\"AWS::EC2::EIP\",\"name\":\"Is attached to ElasticIp\"}],\"configuration\":{\"<foo>\":\"<bar>\"}},\"messageType\":\"ConfigurationItemChangeNotification\"}",
...
KINESIS_DATA_ANALYTICS_COMPRESSED = {
  "invocationId": "invocationIdExample",
  "applicationArn": "arn:aws:kinesisanalytics:us-west-2:123456789012:application/example-application",
  "streamArn": "arn:aws:kinesis:us-west-2:123456789012:stream/example-stream",
  "records": [
    {
      "recordId": "49571347871967966406409637155186850213682522142927749122",
      "data": "H4sIAAAAAAAA/6vmUspLzE1VslLKTsxNzFHS4VJKTEkpSi0uBgol5SRmKHHVAgDd1tysJAAAAA=="
    }
  ]
}
...
CLOUDFRONT_REDIRECT_ON_VIEWER_COUNTRY = {
  "Records": [
    {
      "cf": {
        "config": {
...
CLOUDFRONT_NORMALIZE_QUERYSTRING = {
  "Records": [
    {
      "cf": {
        "config": {
...
CLOUDFRONT_SERVE_OBJECT_ON_VIEWER_DEVICE = {
  "Records": [
    {
      "cf": {
        "config": {
...
KINESIS_DATA_FIREHOSE_APACHELOG = {
  "invocationId": "invocationIdExample",
  "region": "us-west-2",
  "records": [
    {
...
CLOUDFRONT_MULTIPLE_REMOTE_CALLS_AGGREGATE_RESPONSE = {
  "Records": [
    {
      "cf": {
        "config": {
...
CLOUDFRONT_ACCESS_REQUEST_IN_RESPONSE = {
  "Records": [
    {
      "cf": {
        "config": {
...
CONFIG_OVERSIZED_CONFIGURATION_ITEM_CHANGE_NOTIFICATION = {
  "invokingEvent": "{\"configurationItemSummary\": {\"changeType\": \"UPDATE\",\"configurationItemVersion\": \"1.2\",\"configurationItemCaptureTime\":\"2016-10-06T16:46:16.261Z\",\"configurationStateId\": 0,\"awsAccountId\":\"123456789012\",\"configurationItemStatus\": \"OK\",\"resourceType\": \"AWS::EC2::Instance\",\"resourceId\":\"i-00000000\",\"resourceName\":null,\"ARN\":\"arn:aws:ec2:us-west-2:123456789012:instance/i-00000000\",\"awsRegion\": \"us-west-2\",\"availabilityZone\":\"us-west-2\",\"configurationStateMd5Hash\":\"8f1ee69b287895a0f8bc5753eca68e96\",\"resourceCreationTime\":\"2016-10-06T16:46:10.489Z\"},\"messageType\":\"OversizedConfigurationItemChangeNotification\"}",
  "ruleParameters": "{\"<myParameterKey>\":\"<myParameterValue>\"}",
  "resultToken": "myResultToken",
  "eventLeftScope": False,
  "executionRoleArn": "arn:aws:iam::123456789012:role/config-role",
...
CLOUDFRONT_RESPONSE_GENERATION = {
  "Records": [
    {
      "cf": {
        "config": {
