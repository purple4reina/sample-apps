module github.com/DataDog/sample-apps/go/lambda
...
//replace github.com/DataDog/dd-trace-go/contrib/aws/datadog-lambda-go/v2 => /Users/rey.abolofia/go/src/github.com/DataDog/dd-trace-go/contrib/aws/datadog-lambda-go
